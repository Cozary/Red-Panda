...
public class ModSpawnEggs {
    ...
    public static final Supplier<Item> RED_PANDA_EGG = registerWithTab("red_panda_spawn_egg", () -> new DeferredSpawnEggItem(ModEntityTypes.RED_PANDA, 0xFFFFFF, 0xffa500, new Item.Properties()));
